...
public class SlidingPanelHorizontal : MonoBehaviour
{
    public RectTransform panel; // Référence au RectTransform du panneau
    public float closedPositionX; // Position Y fermée (panneau hors de l'écran, en bas)
    public float openPositionX; // Position Y ouverte (panneau visible)
    ...
    void Start()
    {
        ...
        panel.anchoredPosition = new Vector2(closedPositionX, panel.anchoredPosition.y);
    }
    ...
    public void OnToggleValueChanged()
    {
        ...
        float targetX = isOn ? openPositionX : closedPositionX;
